...
static inline void DBG_ARM_TEQ_IMM(TargetCoreType *core, arm_teq_imm_input_type *in, arm_teq_imm_output_type *out)
{
	DBG_PRINT((DBG_EXEC_OP_BUF(), DBG_EXEC_OP_BUF_LEN(),
		DBG_FMT_STR
...
static inline void DBG_ARM_MVN_SHIFT_REG(TargetCoreType *core, arm_mvn_shift_reg_input_type *in, arm_mvn_shift_reg_output_type *out)
{
	DBG_PRINT((DBG_EXEC_OP_BUF(), DBG_EXEC_OP_BUF_LEN(),
		DBG_FMT_STR
...
static inline void DBG_ARM_LDMDB(TargetCoreType *core, arm_ldmdb_input_type *in, arm_ldmdb_output_type *out)
{
	DBG_PRINT((DBG_EXEC_OP_BUF(), DBG_EXEC_OP_BUF_LEN(),
		DBG_FMT_STR
...
static inline void DBG_ARM_VMOV_DREG(TargetCoreType *core, arm_vmov_dreg_input_type *in, arm_vmov_dreg_output_type *out)
{
	DBG_PRINT((DBG_EXEC_OP_BUF(), DBG_EXEC_OP_BUF_LEN(),
		DBG_FMT_STR
		...
		DBG_ARG_PseudoCodeFloatRegisterDataType(&out->Vm),
