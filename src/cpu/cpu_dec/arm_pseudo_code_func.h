...
extern int arm_op_exec_arm_teq_reg(struct TargetCore *core,  arm_teq_reg_input_type *in, arm_teq_reg_output_type *out);
extern int arm_op_exec_arm_teq_imm(struct TargetCore *core,  arm_teq_imm_input_type *in, arm_teq_imm_output_type *out);
...
extern int arm_op_exec_arm_mvn_shift_reg(struct TargetCore *core,  arm_mvn_shift_reg_input_type *in, arm_mvn_shift_reg_output_type *out);
...
extern int arm_op_exec_arm_ldrb_imm(struct TargetCore *core,  arm_ldrb_imm_input_type *in, arm_ldrb_imm_output_type *out);
extern int arm_op_exec_arm_ldrsb_imm(struct TargetCore *core,  arm_ldrsb_imm_input_type *in, arm_ldrsb_imm_output_type *out);
...
extern int arm_op_exec_arm_ldrsb_literal(struct TargetCore *core,  arm_ldrsb_literal_input_type *in, arm_ldrsb_literal_output_type *out);
extern int arm_op_exec_arm_ldrh_imm(struct TargetCore *core,  arm_ldrh_imm_input_type *in, arm_ldrh_imm_output_type *out);
extern int arm_op_exec_arm_ldrsh_imm(struct TargetCore *core,  arm_ldrsh_imm_input_type *in, arm_ldrsh_imm_output_type *out);
extern int arm_op_exec_arm_ldrsh_reg(struct TargetCore *core,  arm_ldrsh_reg_input_type *in, arm_ldrsh_reg_output_type *out);
...
extern int arm_op_exec_arm_ldrb_reg(struct TargetCore *core,  arm_ldrb_reg_input_type *in, arm_ldrb_reg_output_type *out);
extern int arm_op_exec_arm_ldrsb_reg(struct TargetCore *core,  arm_ldrsb_reg_input_type *in, arm_ldrsb_reg_output_type *out);
extern int arm_op_exec_arm_ldrh_reg(struct TargetCore *core,  arm_ldrh_reg_input_type *in, arm_ldrh_reg_output_type *out);
...
extern int arm_op_exec_arm_stmib(struct TargetCore *core,  arm_stmib_input_type *in, arm_stmib_output_type *out);
...
extern int arm_op_exec_arm_ldmib(struct TargetCore *core,  arm_ldmib_input_type *in, arm_ldmib_output_type *out);
extern int arm_op_exec_arm_ldmdb(struct TargetCore *core,  arm_ldmdb_input_type *in, arm_ldmdb_output_type *out);
...
extern int arm_op_exec_arm_ubfx(struct TargetCore *core,  arm_ubfx_input_type *in, arm_ubfx_output_type *out);
...
extern int arm_op_exec_arm_bfi(struct TargetCore *core,  arm_bfi_input_type *in, arm_bfi_output_type *out);
...
extern int arm_op_exec_arm_and_shift_reg(struct TargetCore *core,  arm_and_shift_reg_input_type *in, arm_and_shift_reg_output_type *out);
extern int arm_op_exec_arm_uxt(struct TargetCore *core,  arm_uxt_input_type *in, arm_uxt_output_type *out);
extern int arm_op_exec_arm_rrx(struct TargetCore *core,  arm_rrx_input_type *in, arm_rrx_output_type *out);
...
extern int arm_op_exec_arm_sbc_imm(struct TargetCore *core,  arm_sbc_imm_input_type *in, arm_sbc_imm_output_type *out);
...
extern int arm_op_exec_arm_umull(struct TargetCore *core,  arm_umull_input_type *in, arm_umull_output_type *out);
...
extern int arm_op_exec_arm_asr_reg(struct TargetCore *core,  arm_asr_reg_input_type *in, arm_asr_reg_output_type *out);
extern int arm_op_exec_arm_srs(struct TargetCore *core,  arm_srs_input_type *in, arm_srs_output_type *out);
extern int arm_op_exec_arm_clz(struct TargetCore *core,  arm_clz_input_type *in, arm_clz_output_type *out);
...
extern int arm_op_exec_arm_vnm(struct TargetCore *core,  arm_vnm_input_type *in, arm_vnm_output_type *out);
