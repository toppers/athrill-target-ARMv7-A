...
int arm_op_exec_arm_bic_shift_reg_a1(struct TargetCore *core)
{
	...
	//TODO arguments setting..
	in.instrName = "ARM_BIC_SHIFT_REG_A1";
...
int arm_op_exec_arm_orr_shift_reg_a1(struct TargetCore *core)
{
	...
	//TODO arguments setting..
	in.instrName = "ARM_ORR_SHIFT_REG_A1";
...
int arm_op_exec_arm_and_shift_reg_a1(struct TargetCore *core)
{
	...
	//TODO arguments setting..
	in.instrName = "ARM_AND_SHIFT_REG_A1";
